research_ocin_string = "BTC,ETH,BNB,ADA,DOGE,XRP,DOT,UNI,BCH,LTC,SOL,LINK,MATIC,THETA,WBTC,XLM,ICP,DAI,VET,ETC"

research_ocin_symbols = ['BTC', 'ETH', 'BNB', 'ADA', 'DOGE', 'XRP', 'DOT', 'UNI', 'BCH', 'LTC', 'SOL',
